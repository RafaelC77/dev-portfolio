const projectsList = [
  {
    title: "GamerShop",
    description:
      "Projeto pessoal de um e-commerce com produtos voltados para o mercado gamer. É possível adicionar produtos ao carrinho de compras e realizar pagamentos por meio do Stripe. Além disso, foram implementados testes unitários e de integração.",
    techsList: [
      "NextJS",
      "Sass",
      "Sanity",
